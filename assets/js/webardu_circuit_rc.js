...
/*
// mode temporel - fichier "potentiometre.ino"
mode = "temporel";
commandes = [{texte_bouton:"Mesure", arduino:"mesure"}];

series = [{grandeur: "U", unite: "V"}];
titre_graphe = "Montage potentiométrique";
...
/*
//mode point avec saisie de l'abscisse - fichier "capteur_pression_2.ino"
mode = "point";
